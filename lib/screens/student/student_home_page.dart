...
import 'package:academiview/screens/student/join_classroom_page.dart';
import 'package:academiview/screens/student/classroom_view_page.dart';
import 'package:academiview/screens/home/notes_tab.dart';
...
class _StudentHomePageState extends State<StudentHomePage> with TickerProviderStateMixin {
  ...
  Widget _buildClassroomsTab() {
    return StreamBuilder<List<QueryDocumentSnapshot>>(
      stream: _firestoreService.getStudentClassrooms(),
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => ClassroomViewPage(classroomId: classroomId),
              ),
            );
          },
          child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFeatureCard(
            Icons.school,
            'Join Classrooms',
            'Connect with teachers and access course materials',
            const Color(0xFFFF6F61),
          ),
          _buildFeatureCard(
            Icons.download,
            'View Materials',
            'Download and access learning resources',
            const Color(0xFFFF8A80),
          ),
          _buildFeatureCard(
            Icons.note_alt,
